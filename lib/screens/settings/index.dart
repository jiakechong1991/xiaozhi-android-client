    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            children: [
              Cell('账号安全', onTap: () => Get.toNamed('/settings/account')),
              Cell('修改我的信息', onTap: () => Get.toNamed('/user/update_profile')),
              Cell('账户积分', onTap: () => Get.toNamed('/account/about')),
              Cell('消息通知', onTap: () => Get.toNamed('/settings/notification')),
              Cell('隐私设置', onTap: () => Get.toNamed('/settings/privacy')),
              Cell(
                '清除缓存',
                right: Text('190M', style: TextStyle(fontSize: WcaoTheme.fsL)),
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            top: BorderSide(width: 1, color: WcaoTheme.outline),
                          ),
                        ),
                        child: Text(
                          '清除缓存',
