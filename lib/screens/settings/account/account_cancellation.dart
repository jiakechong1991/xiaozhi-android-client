...
class AccountCancellation extends StatefulWidget {
  const AccountCancellation({Key? key}) : super(key: key);

  @override
  State<AccountCancellation> createState() => _AccountLogoutState();
}

class _AccountLogoutState extends State<AccountCancellation> {
  List<String> texts = [
