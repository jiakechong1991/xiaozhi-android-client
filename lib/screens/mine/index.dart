                  ...
                  background: Stack(
                    children: [
                      SizedBox(
                        ...
                        child: WcaoUtils.imageCache(mine.bg, fit: BoxFit.cover),
                      ),
                      Positioned(
                        child: Container(color: Colors.black.withOpacity(.33)),
                      ),
                      Positioned(
                        bottom: 56,
  ...
  Widget profile() {
    return Center(
      child: Column(
        ...
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          CircleAvatar(radius: 48, backgroundImage: NetworkImage(mine.avatar)),
          Container(
            margin: const EdgeInsets.only(top: 12),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
          ...
          Container(
            ...
            child: Wrap(
              ...
              runSpacing: 6,
              children:
                  List.generate(mine.tags.length, (index) {
