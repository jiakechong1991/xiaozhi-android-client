...
class _SettingsScreenState extends State<SettingsScreen>
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [_buildGeneralTab(), _buildXiaozhiConfigTab()],
            ),
          ),
        ],
      ),
  ...
  Widget _buildXiaozhiConfigTab() {
    ...
    debugPrint(
      'xiaozhiConfigs 内容: ${xiaozhiConfigs.map((e) => e.name).join(', ')}',
    ); // 打印名字方便看
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        configControllerIns.addXiaozhiConfig(
                          name,
                          websocketUrl,
                          customMacAddress:
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        configControllerIns.updateXiaozhiConfig(updatedConfig);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        configControllerIns.deleteXiaozhiConfig(config.id);
